...
const PlaceOrder = () => {
    ...
    useEffect(() => {
        if (!token) {
            toast.error("Sign in first to place an order");
            navigate('/cart');
        } else if (getTotalCartAmount() === 0) {
            navigate('/cart');
        }
        ...
        <form onSubmit={placeOrder} className='place-order'>
            <div className="place-order-left">
                ...
                <div className="order-type">
                    ...
                    <label>
                        <input type="radio" value="dinein" checked={orderType === "dinein"} onChange={() => setOrderType("dinein")} />
                        Dine-in (Table)
                    </label>
                </div>

                {orderType === "dinein" && (
                    <input type="text" name='tableNumber' value={tableNumber} onChange={(e) => setTableNumber(e.target.value)} placeholder='Enter Table Number' required />
                )}
